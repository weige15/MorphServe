...
| H25 | §4.4; Appendix C | Reclaimed weight bytes become physically usable, non-contiguous KV blocks | Address-bound checks, mapping oracle, capacity expansion/shrink/content preservation | **Tested-not-reproduced (partial)**: one synthetic reclaimed region passed physical address/write/restore checks, then released extension crashed at shutdown; multi-region Triton mapping and serving remain unverified |
