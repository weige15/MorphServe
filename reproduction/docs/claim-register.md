...
| H25 | §4.4; Appendix C | Reclaimed weight bytes become physically usable, non-contiguous KV blocks | Address-bound checks, mapping oracle, capacity expansion/shrink/content preservation | **Approximate/modified-condition (partial)**: repaired RTX 3090 reconstruction passes physical reclaim plus two-tail prefill/decode store and attention oracle (max error 0); released extension crashes at shutdown; fixed-stride assumption, safe shrink, and full serving remain unverified |
