...
| B8 | Track agent and GPU budgets separately | PARTIAL | Goal runtime/token usage supplied by harness; per-run wall times and GPU snapshots saved, but no aggregate GPU-hours ledger. |
