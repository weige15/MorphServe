...
| Traces | 72 s Azure and BurstGPT segments; 4.75× and 1.75× downscaling | Primary traces recovered. Figure 1 strongly identifies Azure Code and source-only shape matching yields candidate starts 1073 s and 1,781,278 s, frozen as figure-inferred; author confirmation, scaling/thinning operation and context mapping remain unavailable. |
