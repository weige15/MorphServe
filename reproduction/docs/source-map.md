...
| Morphing Controller | Section 4.1; example thresholds KV >85%, queue delay >100 ms; Section 5 modes | Candidate scheduler is incomplete; reconstruction core `runtime/morphserve/controller.py` | Frozen reconstructed EMA/persistence/hysteresis and accuracy/default/performance modes pass CPU tests. Values beyond paper examples are not author settings; engine/GPU integration pending. |
