...
The combined 22-test command and report verifier pass. GPU 4 remained the least occupied device but had only 16,501 MiB free at 98–100% utilization; all other devices had 13,429–15,729 MiB free. This remains below the frozen 17,408-MiB guard, so no unchanged GPU rerun was attempted. Next step remains the four frozen current-revision GPU runners when safe headroom appears.
