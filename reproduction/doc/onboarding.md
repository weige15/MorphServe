...
Expected CPU result: five tests pass. GPU runners create/clear `reproduction/.venv`, install pinned cached dependencies, save commands/logs/metrics, and return a nonzero code when a predeclared gate fails.
