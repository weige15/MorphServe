"""Run one static Table-5 condition against a frozen workload manifest."""
...
async def run(args: argparse.Namespace) -> Path:
    ...
    if args.quantized_layer_count not in (0, 8, 16, 32):
        raise ValueError("quantized layer count must match a Table-5 condition")
