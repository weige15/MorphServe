"""Regenerate Table-5 quality/latency aggregates and the Pareto plot from raw runs."""
...
def main() -> None:
    ...
    table_path = args.output_dir / "table5_results.csv"
    ...
    aggregate = {
        ...
        "derived_files": ["table5_results.csv", "configuration_summary.csv", "quality_vs_p95_ttft.png"],
        "regeneration_command": "PYTHONPATH=swiftLLM python -m benchmark.table5_analyze --manifest ... --runs ... --output-dir ...",
    }
